...
final class MigrateLoadCommand extends Command
{
    protected $signature = 'migrate:load
        ...
        {--s|skip-data : Skip including data present in the tables that was created via migrations.}';
    ...
    public function handle()
    {
        ...
        $skip_data = $this->option('skip-data') ?? (config('migration-snapshot.data') ? false : true);
        if ( !$skip_data ) {
