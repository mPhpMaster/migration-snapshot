...
final class MigrateDumpCommand extends Command
{
    ...
    protected $signature = 'migrate:dump
        ...
        {--d|include-data : Include data present in the tables that was created via migrations. }
        ';
    ...
    public function handle()
    {
        ...
        $data_sql_path = null;
        $include_data = $this->option('include-data') ?? (config('migration-snapshot.data') ? true : false);
        if ( $include_data ) {
