...
final class DumpDataCommand extends Command
{
    protected $signature = 'db:dump-data
        {--database= : The database connection to use}
        ';

    protected $description = 'Dump current database data as plain-text SQL file.';
    ...
    public function handle()
    {
        ...
        $data_sql_path = database_path() . MigrateDumpCommand::DATA_SQL_PATH_SUFFIX;
